...
<div class="dashboard-main-body">
    <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
        ...
        <ul class="d-flex align-items-center gap-2">
            <li class="fw-medium">
                <a href="{{ route('article.index') }}" class="d-flex align-items-center gap-1 hover-text-primary">
                        ...
                        <ul>
                            ...
                            <li class="d-flex align-items-center gap-1 mb-12">
                                ...
                                <span class="w-70 text-secondary-light fw-medium">
                                    : {{ $article->created_at ? $article->created_at->format('d/m/Y H:i') : 'Non défini' }}
                                </span>
                            </li>
                            ...
                            <li class="d-flex align-items-center gap-1">
                                ...
                                <span class="w-70 text-secondary-light fw-medium">
                                    : {{ $article->updated_at ? $article->updated_at->format('d/m/Y H:i') : 'Non défini' }}
                                </span>
                            </li>
                        </ul>
                    </div>
